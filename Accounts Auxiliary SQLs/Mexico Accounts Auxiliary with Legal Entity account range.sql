...
and "General Ledger - Transactional Balances Real Time"."Natural Account Segment"."Account Code" >= ('@{p_from_account}')
and "General Ledger - Transactional Balances Real Time"."Natural Account Segment"."Account Code" <= ('@{p_to_account}')
